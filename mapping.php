                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="welcome d-flex justify-content-between align-items-center">
                                <h3 class="page-title">Yokoso Reposirtory Administrator-kun!</h3>
...
<div id="container1">
  ...
  <select id="dropdown" onchange="showDescription(this.value)">
      ...
      <option value="1" onclick="showDescription(1)">Surigao Del Sur</option>
      <option value="2" onclick="showDescription(2)">Tarlac</option>
      <option value="3" onclick="showDescription(3)">Tawi Tawi</option>
...
<script>
    ...
    function zoomToPath(e) {
        ...
        offsetX = (clickX - boundingBox.width / 2) * scale;
        offsetY = (clickY - boundingBox.height / 2) * scale;

        updateTransform();
    }

    function hoverPath(e) {
        e.target.style.fill = 'lightblue'; // Change the fill color on hover
    }

    function unhoverPath(e) {
        e.target.style.fill = ''; // Reset the fill color on mouse leave
    }

    zoomContainer.addEventListener('mousedown', startDragging);
    window.addEventListener('mouseup', stopDragging);
    window.addEventListener('mousemove', drag);
    map.addEventListener('click', zoomToPath);
    map.addEventListener('mouseenter', hoverPath);
    map.addEventListener('mouseleave', unhoverPath);
