                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="welcome d-flex justify-content-between align-items-center">
                                <h3 class="page-title">Welcome Reposirtory Administrator!</h3>
                                <button type="button" class="close" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item active"> Hospital Mapping </li>
                            </ul>
                        </div>
                    </div>
                </div>
            <h2>Hospital Mapping</h2>
        </div>
