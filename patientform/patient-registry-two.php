                ...
                <form action="patient-registry-two-submit.php" method="post" autocomplete="off">
                    <div class="row form-rows">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" name="estimate_years_smoking" id="estimate_years_smoking" value=""
                                required>
                        </div>
                        <div class="col-md-3 radio-container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="no_of_sexual_partners" id="no_of_sexual_partners" value=""
                                    required>
                            </div>
                            <div class="col-md-3 radio-container">
                            ...
                            <div class="col-md-3 radio-container">
                                ...
                                <div class="radios">
                                    <div class="no-radio">
                                        <input type="radio" id="family_history_no" name="family_history_with_cancer"
                                            value="false">
                                        <label for="family_history_no">No</label>
                                    </div>
                                    <div class="yes-radio">
                                        <input type="radio" id="family_history_yes" name="family_history_with_cancer"
                                            value="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 radio-container">
                                ...
                                <div class="radios">
                                    <div class="no-radio">
                                        <input type="radio" id="helicobacter_pylori_no" name="helicobacter_pylori_virus"
                                            value="false">
