            ...
            <div class="content container-fluid">
                ...
                <form action="" class="" method="post">
                    ...
                    <div class="col-md-3 radio-container">
                            ...
                            <div class="radios">
                                <div class="no-radio">
                                    <input type="radio" id="non-microscopic-no" name="non-microscopic-no" value="no">
                                    <label for="non-microscopic-no">No</label>
                                </div>
                                <div class="yes-radio">
                                    <input type="radio" id="non-microscopic-yes" name="non-microscopic-yes" value="yes">
                                    <label for="non-microscopic-yes">Yes</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 radio-container">
                            ...
                            <div class="radios">
                                <div class="no-radio">
                                    <input type="radio" id="microscopic-no" name="microscopic-no" value="no">
                                    <label for="microscopic-no">No</label>
                                </div>
                                <div class="yes-radio">
                                    <input type="radio" id="microscopic-yes" name="microscopic-yes" value="yes">
                                    <label for="microscopic-yes">Yes</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 radio-container">
                    ...
                    <div class="row">
                         <div class="col-md-3">
                            ...
                            <input type="text" name="tumor-size" id="tumor-size" value="">
                        </div>
                        <div class="col-md-3">
