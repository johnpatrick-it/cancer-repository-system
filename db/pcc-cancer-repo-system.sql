...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2023 at 09:15 PM
...
CREATE TABLE `hospital_general_information` (
  ...
  `hospital_level` varchar(50) DEFAULT NULL,
  `hospital_region` varchar(50) DEFAULT NULL,
  ...
  `bed_capacity` int(100) DEFAULT NULL,
  `hospital_equipment` varchar(100) DEFAULT NULL
...
INSERT INTO `repo_admin` (`repo_admin_id`, `sa_id`, `attendance_id`, `calendar_id`, `admin_fname`, `admin_lname`, `admin_username`, `admin_password`, `created_at`, `Picture`) VALUES
(1, 1, 1, 1, 'Admin', 'User', 'admin_username', '$2y$10$1Ac4Qz7VOtmvme.RnAzZO.9Dr.B3pPENUIfTKhwR3mwIRwm4J1/bG', '2023-11-25', 'C:/Users/Patrick/Downloads/personal_website/cancer-repository-system/profiles/damo bg.png');
...
--
ALTER TABLE `hospital_general_information`
  MODIFY `hospital_id` int(100) NOT NULL AUTO_INCREMENT;
