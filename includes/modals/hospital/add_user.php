                ...
                <form method="POST" action="includes/modals/hospital/save_user.php" enctype="multipart/form-data"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <input name="first-name" class="form-control" type="text" placeholder="User's First Name"
                                required>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="middle-name">Middle Name</label>
                            <input name="middle-name" class="form-control" type="text" placeholder="User's Middle Name"
                                required>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="last-name">Last Name</label>
                            <input name="last-name" class="form-control" type="text" placeholder="User's Last Name"
                                required>
                        </div>
                        <div class="form-group col-md-3">
