...
if (isset($_POST['submit'])) {
    ...
    // Initialize $hospitalEquipment if it's not defined in your code
	...
	foreach ($hospitalEquipment as $equipment) {
		...
		$stmt->bindParam(':hospital_equipments', $equipment, PDO::PARAM_STR);
		...
		if ($stmt->execute()) {
			...
			echo '</script>';
		 // Redirect to hospital-information.php
		} else {
            ...
            <div class="modal-body">
                <form method="post" action="" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-row" id="equipmentContainer">
                        <?php $cnt = 1; ?>
                        <div class="form-group col-md-3">
                            <label for="hospital-equipment">Hospital Equipment</label>
                ...
                ?>
                    ...
                    <div class="form-row" id="equipmentContainer">
                        <!-- New SELECT DROPDOWN will be appended here -->
                    </div>
...
$(document).ready(function() {
    ...
    function addNewDropdown() {
        var newDropdown = '<div class="form-group col-md-3">' +
            '<label for="hospital-equipment"> ' + counter + ' New Equipment</label>' +
            '<div class="input-group">' +
            '<select name="hospital_equipment[]" class="form-control" required>' +
            '<option value="" disabled selected>Select Medical Equipment</option>' +
            '<?php
